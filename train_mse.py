...
def validate_epoch(dataloader, model, device, saver, draw=False):
    ...
    saver.log_info(' --- <validation> --- mse: {:.6f} '.format(mean_mse))
    saver.log_value({
...
def main():
    ...
    p.add_argument('--deviation', type=float, default=0.02)
    ...
    p.add_argument('--out_dims', type=int, default=1)
